...
###### Webacdémie - Epitech Moulins (2025 - 2027)

- Développement de site web
- Déploiement via GitHub
- Apprendre à apprendre

###### DNMADe Numérique - Lycée Jean Monnet Yzeure (2023 - 2025)

- Design d'interface (UI/UX)
- Design interactif
- Design d'identités visuelles

###### Baccalauréat général - Lycée Grand Air Arcachon (2020 - 2023)

- Options :

    - Numérique et Sciences de l'informatique (NSI)
    - Arts Plastiques
- Optention bac mention assez bien

Expériences professionnelles
----------------------------

###### Stage de deux mois (26 Mai - 18 Juillet 2025)
Moulins Communication  
03000 Moulins

- Créations de visuels
- Application de chartes graphiques

###### Stage d'un mois (28 Avril - 23 Mai 2025)
Office de tourisme  
03100 Montluçon

- Création d'affiches
- Rédaction et gestion des réseaux sociaux

Compétences
-----------

- Cadrage de projet
- Conceptualisation de la solution web
